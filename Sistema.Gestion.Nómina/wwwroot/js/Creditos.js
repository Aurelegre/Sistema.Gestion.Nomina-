            ...
            if (action === "historial") {
                ...
                fetch('/Credito/Details/' + id)
                    ...
                    .then(data => {
                        ...
                        // Mostrar el modal
                        var modal = new bootstrap.Modal(document.getElementById('creditoDetailModal'));
                        modal.show();
...
function createCredito() {
    ...
    // Mostrar el modal
    var modal = new bootstrap.Modal(document.getElementById('createCreditoModal'));
    modal.show();
}
